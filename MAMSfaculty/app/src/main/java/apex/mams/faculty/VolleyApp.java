...
public class VolleyApp extends Application {
    ...
    public int isEmptyEditText(EditText edt) {
    ...
    public static void openFile(Context context, File url) throws IOException {
        ...
        Log.e("ImageManager ", String.valueOf(file));
        ...
        if (file.toString().substring(file.toString().lastIndexOf(".") + 1).equalsIgnoreCase("doc") ||
                file.toString().substring(file.toString().lastIndexOf(".") + 1).equalsIgnoreCase("docx")) {
            // Word document
            intent.setDataAndType(uri, "application/msword");
        } else if (file.toString().substring(file.toString().lastIndexOf(".") + 1).equalsIgnoreCase("pdf")) {
            // PDF file
            intent.setDataAndType(uri, "application/pdf");
        } else if (file.toString().substring(file.toString().lastIndexOf(".") + 1).equalsIgnoreCase("ppt") ||
                file.toString().substring(file.toString().lastIndexOf(".") + 1).equalsIgnoreCase("pptx")) {
            // Powerpoint file
            intent.setDataAndType(uri, "application/vnd.ms-powerpoint");
        } else if (file.toString().substring(file.toString().lastIndexOf(".") + 1).equalsIgnoreCase("xls") ||
                file.toString().substring(file.toString().lastIndexOf(".") + 1).equalsIgnoreCase("xlsx")) {
            // Excel file
            intent.setDataAndType(uri, "application/vnd.ms-excel");
        } else if (file.toString().substring(file.toString().lastIndexOf(".") + 1).equalsIgnoreCase("zip") ||
                file.toString().substring(file.toString().lastIndexOf(".") + 1).equalsIgnoreCase("rar")) {
            // WAV audio file
            intent.setDataAndType(uri, "application/x-wav");
        } else if (file.toString().substring(file.toString().lastIndexOf(".") + 1).equalsIgnoreCase("rtf")) {
            // RTF file
            intent.setDataAndType(uri, "application/rtf");
        } else if (file.toString().substring(file.toString().lastIndexOf(".") + 1).equalsIgnoreCase("wav") ||
                file.toString().substring(file.toString().lastIndexOf(".") + 1).equalsIgnoreCase("mp3")) {
            // WAV audio file
